...
function checkWinConditions() {
    ...
    //This function checks if an array inclludes 3 strings.
...
//This function makes our body element tmporarily unclickable.
...
//This function itilizes html canvas to draw win lines.
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        //This line indicates where the end of a lines x axis is.
        y2 = coordY2,
        //This variable stores temprary x axis data we update in our animation loop.
        x = x1,
        //This variable stores temprary y axis data we update in our animation loop.
        y = y1;
...
function animateLineDrawing() {
    ...
    if (x1 <= x2 && y1 <= y2) {
        //This condition adds 10 to the previous end x pooint. 
        if (x < x2) { x += 10; }
        //This condition adds 10 to the previous end y point.
        if (y < y2) { y += 10; }
        //This condtion cancels our animation loop if reach the end points.
        if (x >= x2 && y >= y2) { cancelAnimationFrame(animationLoop); }
    }
    //This condition is similar to the one above.
    //It was nevessary for the 6, 4, 2 win condition.
    if (x1 <= x2 && y1 >= y2) {
        if (x < x2) { x += 10; }
        if (y > y2) { y -= 10; }
        if (x >= x2 && y <= y2) { cancelAnimationFrame(animationLoop); }
